    ...
    <div class="todos-toolbar">
      ...
      <div class="todos-filter-row">
        <div class="todos-filter-group">
          ...
          <button
            :class="['tfg-btn', { active: statusFilter === 'all' }]"
            @click="setStatus('all')"
          >
            전체
          </button>
          <button
            :class="['tfg-btn', { active: statusFilter === 'active' }]"
            @click="setStatus('active')"
          >
            진행
          </button>
          <button
            :class="['tfg-btn', { active: statusFilter === 'done' }]"
        ...
        <div class="todos-filter-group">
          ...
          <button
            :class="['tfg-btn', { active: priorityFilter === null }]"
            @click="setPriority(null)"
          >
            전체
          </button>
          <button
            :class="['tfg-btn pri-high', { active: priorityFilter === 3 }]"
            @click="setPriority(3)"
          >
            🔴 높음
          </button>
          <button
            :class="['tfg-btn pri-mid', { active: priorityFilter === 2 }]"
            @click="setPriority(2)"
          >
            🟡 보통
          </button>
          <button
            :class="['tfg-btn pri-low', { active: priorityFilter === 1 }]"
            @click="setPriority(1)"
          >
            🟢 낮음
          </button>
        ...
        <div
          ...
          class="todos-filter-group"
        >
          <span class="tfg-label">카테고리</span>
          <button
            :class="['tfg-btn', { active: !categoryFilter }]"
            @click="setCategory('')"
          >
            전체
          </button>
