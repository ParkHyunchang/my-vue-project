    ...
    <template #body>
      <div class="create-form">
        ...
        <div class="form-group">
          ...
          >
          <div
            v-if="newUser.email && !isNewUserEmailValid"
            class="error-message"
          >
            올바른 이메일 형식이 아닙니다.
          </div>
        ...
        <div class="form-group">
          ...
          >
          <div
            v-if="newUser.password && newUser.password.length < 6"
            class="error-message"
          >
        ...
        <div class="form-group">
          ...
          >
          <div
            v-if="newUser.password && newUser.confirmPassword && newUser.password !== newUser.confirmPassword"
            class="error-message"
          >
            비밀번호가 일치하지 않습니다.
          </div>
        ...
        <div class="form-group">
          ...
          <div
            v-if="newUser.role === 'ADMIN' && !isAllowedAdmin(newUser.userId)"
            class="error-message"
          >
