<template>
  ...
  >
    <div class="career__inner">
      ...
      <div
        v-else-if="error"
        class="home-section-state home-section-state--error"
        role="alert"
      >
        <p>{{ error }}</p>
        <button
        ...
        >
          ...
          <div class="career__body">
            ...
            <ul class="career__projects">
              <li
                v-for="(proj, i) in parseJson(item.projects)"
                :key="i"
              >
                {{ proj }}
              </li>
            ...
            <div class="career__tags">
              <span
                v-for="(tag, i) in parseJson(item.tags)"
                :key="i"
              >{{ tag }}</span>
            </div>
          </div>
