      ...
      <tbody>
        ...
        >
          ...
          <template v-else>
            ...
            <td class="td-r">
              {{ isCashHolding(h) ? fmtKRW(Number(h.quantity) || 0) : h.quantity.toLocaleString() }}
            </td>
            <td class="td-r">
              {{ fmtCurPrice(h) }}
            </td>
            ...
            <td class="td-r">
              ...
              <span
                v-else
                :class="['pnl-pct', pnlCls(holdPnlPct(h))]"
              >{{ fmtHoldPnlPct(h) }}</span>
            </td>
            <td class="td-act">
              <button
                v-if="!isCashHolding(h)"
